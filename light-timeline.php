            ...
            <div class="col-md-3 d-flex flex-column align-items-center profile-section">
                ...
                <div>
                    ...
                    <ul class="menu-wrapper d-flex flex-column">
                        <a href="">
                            <li class="menu-item text-center">Draft</li>
                        </a>
                        <a href="#">
                            <li class="menu-item text-center">My Blogs</li>
                        </a>
                        <a href="#">
                ...
                <div>
                    ...
                    <ul class="menu-wrapper d-flex flex-column">
                        <a href="#">
                            <li class="menu-item text-center">English (US)</li>
                        </a>
                        <a href="#">
                            <li class="menu-item text-center">Privacy</li>
                        </a>
                        <a href="#">
                            <li class="menu-item text-center">Terms of Use</li>
                        </a>
                        <a href="#">
                            <li class="menu-item text-center">Contact</li>
                        </a>
                        <a href="#">
                            <li class="menu-item text-center">Advertise with us</li>
                        </a>
